    ...
    <main className="overflow-hidden bg-background text-foreground">
      <header className="fixed inset-x-0 top-0 z-40 border-b border-white/15 bg-slate-950/70 text-white backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          <a href="#top" className="flex items-center gap-3" aria-label="Easy Pools and Spas home">
            ...
            <span className="text-lg font-extrabold uppercase tracking-tight text-white sm:text-xl">Easy Pools &amp; Spas</span>
          </a>
          ...
          <div className="flex items-center gap-2">
            <a href={`tel:${phone}`} className="hidden items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-sm font-bold transition-colors hover:bg-white/10 sm:flex"><Phone className="size-4" /> {displayPhone}</a>
      ...
      <section id="top" className="relative isolate flex min-h-[780px] items-end overflow-hidden bg-slate-950 pb-20 pt-36 text-white lg:min-h-screen lg:pb-28">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 lg:px-8"><Reveal className="max-w-4xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row"><a href={`tel:${phone}`} className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-4 font-bold text-slate-950 transition-transform hover:scale-105"><Phone className="size-4" /> {displayPhone}</a><a href={whatsapp} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full bg-cyan-400 px-6 py-4 font-semibold text-slate-950 transition-transform hover:scale-105">Start your project <ArrowRight className="size-4" /></a><a href="#projects" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/30 px-6 py-4 font-semibold transition-colors hover:bg-white/10"><Play className="size-4 fill-current" /> See our work</a></div>
        </Reveal></div>
